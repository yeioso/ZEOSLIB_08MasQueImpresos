unit TBL030.Movto_Inventario;

interface
Uses
  UtConexion;

Function TBL030_Movto_Inventario_Create(pCnx : TConexion) : Boolean;
...
Begin
  ...
  Begin
    Try
      ...
      pCnx.TMP.SQL.Add(' ' + pCNX.FOREINGKEY(gInfo_Tablas[Id_TBL_Movto_Inventario].Fk[5],'CODIGO_AREA'     , gInfo_Tablas[Id_TBL_Area                   ].Name, 'CODIGO_AREA'     ) + '  ');
    ...
    Except
      ...
      Begin
        Result := False;
        UtLog_Execute(MessageError(IE_ERROR_CREATE) + ' Tabla ' + gInfo_Tablas[Id_TBL_Producto].Name + ', TBL030_Movto_Inventario_Create, ' + E.Message);
      End;
    End;
  End;
End;
